...
use App\Filament\Resources\ScarfResource\Pages;
...
class ScarfResource extends Resource
{
    protected static ?string $model = Scarf::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'تصاميم الوشاح';
    protected static ?string $modelLabel = 'وشاح';
    protected static ?string $pluralModelLabel = 'الوشاحات';
    ...
    {
        return [
            'index' => Pages\ListScarves::route('/'),
            'create' => Pages\CreateScarf::route('/create'),
            'edit' => Pages\EditScarf::route('/{record}/edit'),
        ];
    }
}
